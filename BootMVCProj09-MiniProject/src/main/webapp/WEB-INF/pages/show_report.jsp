  ...
  <c:when  test="${!empty empsData}">
      ...
      <c:forEach var="emp" items="${empsData}">
         <tr class="table-success">
            ...
            <td>${emp.job}</td>
            <td>${emp.sal}</td>
            <td><a href="edit?no=${emp.eno}"><img src="images/edit.jpg" width="30px" height="35px"/></a>  
                     &nbsp;&nbsp;&nbsp;
                     <a href="delete?no=${emp.eno}" onclick="return confirm('Do u want to Delete')"><img src="images/delete.jpg" width="30px" height="35px"/></a>
                     </td>
         </tr>
      </c:forEach>
      </table>
