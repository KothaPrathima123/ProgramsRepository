...
public class Test05_ArrayListInternals {
	...
	//Operation #6: Retrieving an object from the given index (>=0 &&<size())
		...
		//Operation #6: Retrieving an object from the given index (>=0 &&<size())
		System.out.println(al.remove("a")); //"a".equals(eles);
		System.out.println(al);
		System.out.println(al.remove("B")); //"B".equals(eles);
		System.out.println(al);
		System.out.println(al.remove(new String("a"))); //new String("b").equals(eles);
		System.out.println(al);
		System.out.println(al.remove(5)); //index 5 location object is removed
		System.out.println(al);
		System.out.println(al.remove((Integer)5)); //Integer(5).equals(eles);
		System.out.println(al);
		//System.out.println(al.remove('p')); //IOOBE: 112 index is not avaiable
		System.out.println(al.remove((Character)'p')); //'p' is removed by equals()
		System.out.println(al);
		System.out.println(al.remove(6.7)); //6.7 is removed by equals()
		System.out.println(al);
		System.out.println(al.remove(new Ex(5,6))); //!rem =>equals() !Ovr
		System.out.println(al);
		System.out.println(al.remove(new Sa(5,6))); //!rem =>data is diff
		System.out.println(al);
		System.out.println(al.remove(new Sa(15,16))); //rem =>data is same
		System.out.println(al);
		System.out.println();
